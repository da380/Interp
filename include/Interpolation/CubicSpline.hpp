...
class CubicSpline {
  public:
    ...
    // General constructor.
    CubicSpline(xIter xS, xIter xF, yIter yS, CubicSplineBC left,
                y_value_type ypl, CubicSplineBC right, y_value_type ypr)
    ...
    CubicSpline(xIter xS, xIter xF, yIter yS)
        : CubicSpline(xS, xF, yS, CubicSplineBC::Free, 0, CubicSplineBC::Free,
                      0) {}

    // Constructor when boundary conditions are the same.
    CubicSpline(xIter xS, xIter xF, yIter yS, CubicSplineBC both,
                y_value_type ypl, y_value_type ypr)
